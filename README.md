## Project: Face Recognition System Using OpenCV, VGG16, Vector Database & NER Models
Sample Scripts 
(https://github.com/KhushiML/Data_ScienceProjects/blob/main/workflow_ner_openclipV15.py)
(https://github.com/KhushiML/Data_ScienceProjects/blob/main/workflow_ner_openclipV15.py)
...
Sample Scripts
(https://github.com/KhushiML/Speech_To_Text)
...
(https://github.com/KhushiML/Data_ScienceProjects/blob/main/Lab_2_fine_tune_generative_ai_model.ipynb)
(https://github.com/KhushiML/Data_ScienceProjects/blob/main/Lab_3_fine_tune_model_to_detoxify_summaries.ipynb)
### Description:
...
## Project: Iris Flower Classification, CodSoft Internship
...
## Project: Titanic Survival Prediction, CodSoft Internship.
...
## Project: Credit Card Clustering with Machine Learning
...
## Project:  Weather Forecasting using Python
...
## Project: Cryptocurrency Price Prediction
...
## Project: Retail Price Optimization Using Python.
...
- Used **Decision Tree Regressor** for the task of Retail Price Optimization.
### Dataset:
[https://statso.io/retail-price-optimization-case-study/]

## Project: Salary Prediction Using Python.
(https://github.com/KhushiML/Data_ScienceProjects/blob/main/Salary%20Prediction.ipynb)
### Description :
- To find relationships in the data on how the salary is determined.
- Used **Linear Regression** to predict salary with Machine Learning.
### Dataset:
[https://statso.io/salary-prediction-case-study/]

## Project: Student Marks Prediction Model.
...
- Used **Linear Regression** (Accuracy = 94.60%) for prediction of student marks.
### Dataset:
...
## Project: Dogecoin Price Prediction with SARIMAX
...
## Project: Disease Prediction Using SVM Classifier
...
## Project: Parkinson Disease Prediction using XGBoost Classifier
